...
const Profile: React.FC = () => {
  ...
  const { currentUser, updateUser, showToast, importLocalData } = useStore();
            ...
            <div className="bg-gradient-to-r from-purple-900 to-slate-900 rounded-xl p-4 text-white shadow-lg relative overflow-hidden">
             ...
             <div className="space-y-3">
                ...
                <button 
                    ...
                    className="w-full py-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl font-bold text-sm flex items-center justify-center space-x-2 border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
                >
                    <Icons.Download className="w-4 h-4"/>
                    <span>Importar dados deste dispositivo</span>
                </button>
            </div>
        )}
             ...
             {allCurrencies.map(c => {
                ...
                return (
                  <button 
                    ...
                    className={`aspect-square rounded-2xl flex flex-col items-center justify-center transition-all duration-300 relative ${
                       isActive 
